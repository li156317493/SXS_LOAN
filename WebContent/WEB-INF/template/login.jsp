			...
			<div class="main-inner">
				<div class="login-box">
					<ul class="box">
						...
						<li><input id="pass" class="attestation" maxlength="40" type="text" placeholder="验证码2:"/><a href="#" onclick="javascript:getValCode();" class="dx_yzm">发送短信验证码</a></li>
						<li></li>
